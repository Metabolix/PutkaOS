...
Jim Boemler (jboemler@halcyon.com)
  ...
  This header created on Mon Apr  2 20:34:58 PDT 2007
...
PCI_DEVTABLE	PciDevTable [] =
{
	...
	{ 0x5333, 0x8C03, "86C280 db", "ViRGE /MX" } ,
	...
	{ 0x8086, 0x2415, "Intel 82801DBM IDE Controller (UltraATA/100)", "Aureal (AD1881 SOUNDMAX) Placa Mãe Asaki P3-141" } ,
	...
	{ 0x8086, 0x24C6, "82801/DBL/DBM", "AC97 Modem Controller" } ,
	...
	{ 0x8086, 0x24D5, "815B104D", "multimedia audio device" } ,
	...
	{ 0x8086, 0x266D, "Intel 82801GB ICH7", "Intel 82801FBM ICH6-M - AC'97 Audio Controller [B-1]" } ,
	...
	{ 0x8086, 0x27c3, "-", "Intel MegaRAID Storage technology" } ,
	...
	{ 0x8086, 0x4220, "MPCI3B", "Intel PRO/Wireless 2200BG" } ,
	{ 0x8086, 0x4222, "3945ABG", "Intel 3945ABG Wireless LAN controller" } ,
	...
	{ 0x1180, 0x0592, "unknown", "Ricoh Memory Stick Host Controller" } ,
	{ 0x1180, 0x0822, "unknown", "unknown" } ,
	...
	{ 0x14F1, 0x2702, "0780", "01" } ,
	{ 0x14F1, 0x2F00, "?", "HSF 56k HSFi Modem" } ,
	{ 0x14F1, 0x2F20, "CC_0780", "?" } ,
	{ 0x14F1, 0x2F30, "AZTECH3885K", "Conexant 56k PCI Soft Modem" } ,
	...
	{ 0x168C, 0x001A, "Atheros AR5005G", "Atheros AR5005G 802.11abg NIC Chipset" } ,
	...
	{ 0x168C, 0xFF96, "?", "LAN-Express AS IEEE 802.11g miniPCI adapter" } ,
	...
	{ 0x1002, 0x4354, "215r2qzua21", "bcg 62" } ,
	...
	{ 0x1002, 0x4749, "TI 3D RAGE PRO AGP 2X (GT-C2U2)", "ATI ALL IN WONDER PRO (8MB)" } ,
	...
	{ 0x1002, 0x4759, "215r2qzua21", "ATI 3D RAGE 11C AGP(A12/A13)" } ,
	...
	{ 0x1002, 0x5460, "unknown", "Radeon X300 Mobility (M22)" } ,
	...
	{ 0x1013, 0x6005, "CS4280", "CrystalClear PCI Audio Interface" } ,
	...
	{ 0x1023, 0x8520, "Trident Video Accelerator CyberBlade i1", "windows 2000" } ,
	{ 0x1023, 0x8620, "CyberBlade-i1", "hghg" } ,
	...
	{ 0x1023, 0x9910, "00011179", "CyberBlade XP" } ,
	...
	{ 0x1039, 0x0900, "SiS950", "vga driver" } ,
	...
	{ 0x1039, 0x1039, "SiS5597", "SiS5597 SVGA (Shared RAM)" } ,
	{ 0x1039, 0x1040, "", "" } ,
	{ 0x1039, 0x10ec, "", "" } ,
	...
	{ 0x1039, 0x7013, "SiS7013", "modem 56k" } ,
	...
	{ 0x104C, 0xAC13, "PCI104c", "PCI-TO-PC CARD16 CONTROLLER UNIT" } ,
	...
	{ 0x1050, 0x1050, "W99200F", "MULTIMEDIA ADAPTER" } ,
	...
	{ 0x1319, 0x0801, "FM0801", "Xwave PCI audio controller" } ,
	...
	{ 0x13F6, 0x0100, "CMI8338/PCI C3DX", "PCI Àóäèî ×èï" } ,
	{ 0x13F6, 0x0101, "CMI8338-031", "PCI Audio Device" } ,
	{ 0x13F6, 0x0111, "CMI8738/PCI C3DX", "Ýòî - èñïîëüçîâàíèÿ YMF744-B-V îòìå÷åííûé ÷èï" } ,
	{ 0x13F6, 0x0112, "CMI-8378B/PCI-6CH", "PCI Audio Chip" } ,
	{ 0x13F6, 0x0211, "HSP56 MICROMODEM", "modem Riser for P6STF" } ,
	...
	{ 0x10B9, 0x10b9, "ALI M5273 A1", "0518TS05 CKB29751000B" } ,
	...
	{ 0x10B9, 0x5237, "M5273 A1 for windows me", "OpenHCI 1.1 USB to  2.0" } ,
	...
	{ 0x10E8, 0x4750, "S5933", "amcc PCI MatchMaker" } ,
	...
	{ 0x10EC, 0x8029, "RTL8029(as)pci ethernet nic", "RTL8029 (ne2000 Compliant) ethernet nic" } ,
	...
	{ 0x10EC, 0x8139, "RTL8139", "10/100 Mbps Fast Ethernet NIC" } ,
	...
	{ 0x1102, 0x0002, "t4830020080332", "Sound Blaster Live! (Also Live! 5.1) - OEM from DELL - CT4780" } ,
	...
	{ 0x1106, 0x0571, "VT82C596x", "drivers" } ,
	...
	{ 0x1106, 0x3343, "?", "?" } ,
	{ 0x1106, 0x3344, "?", "VIA/S3G UniChrome Pro IGP" } ,
	...
	{ 0x13F0, 0x0200, "-asdfsaf", "ST201 Fast Ethernet Adapter" } ,
	...
	{ 0x14E4, 0x1693, "O", "Ethernet Controller" } ,
	{ 0x14E4, 0x1696, "BCM5782", "Broadcom NetXtreme Gigabit Ethernet for hp" } ,
	{ 0x14E4, 0x169C, "fhjfhjghj", "Broadcom NetLink (TM) Gigabit Ethernet" } ,
	{ 0x14E4, 0x169D, "BCM5789", "Broadcom Ethernet Adapter" } ,
	...
	{ 0x1131, 0x7130, "SAA7130HL", "" } ,
	{ 0x1131, 0x7133, "Philips SAA7135hl", "TV/Radio Tuner" } ,
	{ 0x1131, 0x7134, "SAA7134HL", "Multi Media Capture Device" } ,
	{ 0x1131, 0x7145, "SAA7135hl", "Multimedia audio controler" } ,
	{ 0x1131, 0x7146, "i845E", "Multi Media Bridge Scaler" } ,
	...
	{ 0x1179, 0x0805, "VEN_1179&DEV_0805&SUBSYS_00011179&REV_03", "SD Card Controller" } ,
	...
	{ 0x11AB, 0x11AB-4632, "88E8053", "Marvell Yukon 88E8053 PCI-E Gigabit Ethernet Controller" } ,
	...
	{ 0x11AB, 0x4362, "81421043", "Yukon PCI-E Gigabit Ethernet Controller" } ,
	...
	{ 0x11BD, 0x0015, "660806", "rob2d" } ,
	{ 0x11BD, 0xBEBE, "51015777", "mb87j3560" } ,
	{ 0x11BD, 0xBEDE, "51015544", "MB87J3560" } ,
	...
	{ 0x11C1, 0x048C, "SV92Pl -T00", "modem" } ,
