...
C_SOURCES=gdt.c isr.c main.c mem.c panic.c timer.c floppy.c idt.c irq.c keyboard.c memory.c screen.c string.c kprintf.c blockdev.c thread.c process.c regs.c malloc.c ext2.c mount.c devmanager.c filesystem.c pseudofsdriver.c stdio.c spinlock.c sh.c
